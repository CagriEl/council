...
<head>
    ...
    <style>
        /* Erken splash: CSS/JS flash yok — stiller head'de, içerik kb-loading bitene kadar gizli */
        html.kb-loading {
            background: linear-gradient(160deg, #003d99 0%, #0052cc 45%, #00a0e0 100%) !important;
        }
        html.kb-loading,
